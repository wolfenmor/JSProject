...
for (const item of coursesAndDurationArray) {
    ...
    div.innerText = `title: ${item.title} Duration : ${item.monthDuration}`
    body2.appendChild(div);
}

// За допомоги скріпта для кожного елементу масиву зробити
// <div class='item'> ,  в якому буде <h1 class='heading'>  з title  елементу, та <p class='description'> з monthDuration елементу.
// Завдання робити через цикли.
...
// Проітерувати massive simpsons, створиши для кожного
// об'єкту  масиву <div class='member'> та наповнити його данними з об'єкту.
...
body4 = document.querySelector(`body`);
...
body5 = document.querySelector(`body`);
let coursesArray = [
    {
